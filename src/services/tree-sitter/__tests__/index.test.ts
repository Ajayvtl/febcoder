		  ...
		  <label className="block font-medium mb-1">
			...
			const mockQuery = {
				captures: jest.fn().mockImplementation(() => {
					...
					if (mockFebtNode.printTree) {
						console.log(mockFebtNode.printTree())
					} else {
						console.log("Tree structure:", JSON.stringify(mockFebtNode, null, 2))
					}
