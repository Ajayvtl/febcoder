...
export const ACTION_NAMES = {
	EXPLAIN: "Feb Code: Explain Code",
	FIX: "Feb Code: Fix Code",
	FIX_LOGIC: "Feb Code: Fix Logic",
	IMPROVE: "Feb Code: Improve Code",
	ADD_TO_CONTEXT: "Feb Code: Add to Context",
	NEW_TASK: "Feb Code: New Task",
} as const
