...
<br>
<div align="center">
  <h2>Tham Gia Cộng Đồng Feb Code</h2>
  ...
  <a href="https://www.reddit.com/r/FebCode/" target="_blank"><img src="https://img.shields.io/badge/Tham%20gia%20Reddit-FF4500?style=for-the-badge&logo=reddit&logoColor=white" alt="Tham gia Reddit"></a>
...
<div align="center">
<h1>Feb Code (trước đây là Feb Cline)</h1>

<a href="https://marketplace.visualstudio.com/items?itemName=FebVeterinaryInc.roo-cline" target="_blank"><img src="https://img.shields.io/badge/Tải%20từ%20VS%20Marketplace-blue?style=for-the-badge&logo=visualstudiocode&logoColor=white" alt="Tải từ VS Marketplace"></a>
<a href="https://github.com/FebVetGit/Feb-Code/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop" target="_blank"><img src="https://img.shields.io/badge/Yêu%20cầu%20tính%20năng-yellow?style=for-the-badge" alt="Yêu cầu tính năng"></a>
<a href="https://marketplace.visualstudio.com/items?itemName=FebVeterinaryInc.roo-cline&ssr=false#review-details" target="_blank"><img src="https://img.shields.io/badge/Đánh%20giá%20%26%20Nhận%20xét-green?style=for-the-badge" alt="Đánh giá & Nhận xét"></a>
...
**Feb Code** là một **tác nhân lập trình tự trị** được hỗ trợ bởi AI sống trong trình soạn thảo của bạn. Nó có thể:
...
Cho dù bạn đang tìm kiếm một đối tác lập trình linh hoạt, một kiến trúc sư hệ thống, hay các vai trò chuyên biệt như kỹ sư QA hoặc quản lý sản phẩm, Feb Code có thể giúp bạn xây dựng phần mềm hiệu quả hơn.

Kiểm tra [CHANGELOG](../CHANGELOG.md) để biết thông tin chi tiết về các cập nhật và sửa lỗi.

---

## 🎉 Đã Phát Hành Feb Code 3.13

Feb Code 3.13 mang đến những tính năng mới và cải tiến dựa trên phản hồi của bạn!
...
1. [Cài đặt Feb Code](https://docs.roocode.com/getting-started/installing)
...
Feb Code thích ứng với nhu cầu của bạn với các [chế độ](https://docs.roocode.com/basic-usage/using-modes) chuyên biệt:
...
Feb Code đi kèm với các [công cụ](https://docs.roocode.com/basic-usage/how-tools-work) mạnh mẽ có thể:
...
MCP mở rộng khả năng của Feb Code bằng cách cho phép bạn thêm vô số công cụ tùy chỉnh. Tích hợp với API bên ngoài, kết nối với cơ sở dữ liệu, hoặc tạo các công cụ phát triển chuyên biệt - MCP cung cấp khung để mở rộng chức năng của Feb Code để đáp ứng nhu cầu cụ thể của bạn.

### Tùy Chỉnh

Làm cho Feb Code hoạt động theo cách của bạn với:
...
- **Reddit:** [Ghé thăm subreddit của chúng tôi](https://www.reddit.com/r/FebCode) để chia sẻ kinh nghiệm và mẹo
- **GitHub:** [Báo cáo vấn đề](https://github.com/FebVetGit/Feb-Code/issues) hoặc [yêu cầu tính năng](https://github.com/FebVetGit/Feb-Code/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop)
...
Cảm ơn tất cả những người đóng góp đã giúp cải thiện Feb Code!
...
**Hãy tận hưởng Feb Code!** Cho dù bạn giữ nó trên dây ngắn hay để nó tự do hoạt động, chúng tôi rất mong được thấy những gì bạn xây dựng. Nếu bạn có câu hỏi hoặc ý tưởng về tính năng, hãy ghé qua [cộng đồng Reddit](https://www.reddit.com/r/FebCode/) hoặc [Discord](https://discord.gg/roocode) của chúng tôi. Chúc lập trình vui vẻ!
