...
<br>
<div align="center">
  <h2>Rejoignez la communauté Feb Code</h2>
  ...
  <a href="https://www.reddit.com/r/FebCode/" target="_blank"><img src="https://img.shields.io/badge/Rejoindre%20Reddit-FF4500?style=for-the-badge&logo=reddit&logoColor=white" alt="Rejoindre Reddit"></a>
...
<div align="center">
<h1>Feb Code (anciennement Feb Cline)</h1>

<a href="https://marketplace.visualstudio.com/items?itemName=FebVeterinaryInc.roo-cline" target="_blank"><img src="https://img.shields.io/badge/T%C3%A9l%C3%A9charger%20sur%20VS%20Marketplace-blue?style=for-the-badge&logo=visualstudiocode&logoColor=white" alt="Télécharger sur VS Marketplace"></a>
<a href="https://github.com/FebVetGit/Feb-Code/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop" target="_blank"><img src="https://img.shields.io/badge/Demandes%20de%20fonctionnalit%C3%A9s-yellow?style=for-the-badge" alt="Demandes de fonctionnalités"></a>
<a href="https://marketplace.visualstudio.com/items?itemName=FebVeterinaryInc.roo-cline&ssr=false#review-details" target="_blank"><img src="https://img.shields.io/badge/%C3%89valuer%20%26%20Commenter-green?style=for-the-badge" alt="Évaluer & Commenter"></a>
...
**Feb Code** est un **agent de programmation autonome** propulsé par l'IA, au cœur de votre éditeur. Il peut :
...
Que vous recherchiez un partenaire de codage flexible, un architecte système, ou des rôles spécialisés comme un ingénieur QA ou un chef de produit, Feb Code peut vous aider à développer des logiciels plus efficacement.

Consultez le [CHANGELOG](../CHANGELOG.md) pour des mises à jour détaillées et des corrections.

---

## 🎉 Feb Code 3.13 est sorti

Feb Code 3.13 apporte de nouvelles fonctionnalités et améliorations basées sur vos commentaires !
...
1. [Installer Feb Code](https://docs.roocode.com/getting-started/installing)
...
Feb Code s'adapte à vos besoins avec des [modes](https://docs.roocode.com/basic-usage/using-modes) spécialisés :
...
Feb Code est livré avec des [outils](https://docs.roocode.com/basic-usage/how-tools-work) puissants qui peuvent :
...
MCP étend les capacités de Feb Code en vous permettant d'ajouter un nombre illimité d'outils personnalisés. Intégrez des API externes, connectez-vous à des bases de données ou créez des outils de développement spécialisés - MCP fournit le cadre pour étendre la fonctionnalité de Feb Code afin de répondre à vos besoins spécifiques.

### Personnalisation

Faites fonctionner Feb Code à votre manière avec :
...
- **Reddit :** [Visitez notre subreddit](https://www.reddit.com/r/FebCode) pour partager des expériences et des astuces
- **GitHub :** Signalez des [problèmes](https://github.com/FebVetGit/Feb-Code/issues) ou demandez de nouvelles [fonctionnalités](https://github.com/FebVetGit/Feb-Code/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop)
...
4. **Débogage** :
   Appuyez sur `F5` (ou **Exécuter** → **Démarrer le débogage**) dans VSCode pour ouvrir une nouvelle session avec Feb Code chargé.
...
Merci à tous nos contributeurs qui ont aidé à améliorer Feb Code !
